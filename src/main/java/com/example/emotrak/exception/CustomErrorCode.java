...
public enum CustomErrorCode {
    ...
    INVALID_TOKEN(UNAUTHORIZED, "x-1001", "JWT 토큰이 만료되었습니다."),
    NON_TOKEN(UNAUTHORIZED, "x-1002", "로그인이 필요합니다."),
    REFRESH_TOKEN_IS_EXPIRED(UNAUTHORIZED, "x-1003", "Refresh 토큰이 만료되었습니다."),
    ...
    DUPLICATE_REPORT(CONFLICT,"x-1003" ,"이미 신고된 내역이 존재합니다." ),
